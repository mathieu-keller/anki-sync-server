...
RUN cargo install --git https://github.com/ankitects/anki.git --tag 25.07.2 anki-sync-server --target x86_64-unknown-linux-musl
...
LABEL org.opencontainers.image.created=$NOW \
      ...
      org.opencontainers.image.version="25.07.2" \
      org.opencontainers.image.revision="25.07.2" \
